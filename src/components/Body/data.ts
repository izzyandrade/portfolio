  ...
  properties: [
    {
      index: 0,
      title: "Github",
      description: "Check out my Github, you can find some cool projects there",
      type: "link",
      link: "https://www.github.com/izzyandrade",
      img: "github.png",
    },
    {
      index: 1,
      title: "LinkedIn",
      description:
        "A great place to know a little more about my carreer, connect with me if you like!",
      type: "link",
      link: "https://www.linkedin.com/in/devisraelandrade",
      img: "linkedin.png",
    },
    {
      index: 2,
      title: "WhatsApp",
      description:
        "This link will contact me directly on your whatsapp if you need any of my services",
      type: "link",
...
export const aboutMeSection = {
  info: [
    ...
    {
      index: 1,
      text: `In addition to my everyday job at Wiser, I also do some freelance jobs for different companies, and develop the most varied applications, both for web and also mobile. In the next sections
      I will show some of this projects, not only the freelance ones, but also projects I have made for study or personal purposes. Also, fell free to contact me in any of the above links I have provided
      . Feel free to share content, ask me anything, and talk about any areas of technology. (I am also a great games/movies/music lover!)`,
      img: "project.png",
    },
  ],
};
